...
export const DatePicker = ({ placeholder, setDateTime, dateTime }) => {
  ...
  const isToday = (date) =>
    isEqual(
      new Date(dateTime.getFullYear(), dateTime.getMonth(), date),
      dateTime
    );
  ...
  const isSelectedMonth = (month) =>
    isEqual(
      new Date(dateTime.getFullYear(), month, dateTime.getDate()),
      dateTime
    );
  ...
  return (
    <div className="w-full">
      <div className="relative">
        ...
        >
          <svg
            className="h-6 w-6 text-violet-200/30"
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
          >
