    ...
    <div className="relative p-32 z-10 bg-white shadow-lg">
      ...
      <div class="text-base mt-8">
        <p>
          ...
          the NFTs using NEAR blockchain. Before you use the App, however, you
          will need to agree to these Terms of Use and any terms and conditions
          incorporated herein by reference (collectively, these “Terms").
        </p>
        <br />
        <p>
          ...
          APP OR ANY PART OF IT, YOU ARE CONFIRMING THAT YOU UNDERSTAND AND
          AGREE TO BE BOUND BY ALL OF THESE TERMS. IF YOU ARE ACCEPTING THESE
          ...
          BEHALF AND BIND THAT ENTITY, IN WHICH CASE “YOU” WILL MEAN THAT
          ENTITY. IF YOU DO NOT HAVE SUCH AUTHORITY, OR IF YOU DO NOT ACCEPT ALL
          OF THESE TERMS, THEN WE ARE UNWILLING TO MAKE THE APP AVAILABLE TO
          YOU.
        </p>
        <br />
        <p>
          ANY PURCHASE OR SALE YOU MAKE, ACCEPT OR FACILITATE OUTSIDE OF THIS
          APP (AS DEFINED BELOW) OF A COLLECTIBLE WILL BE ENTIRELY AT YOUR RISK.
          WE DO NOT CONTROL OR ENDORSE PURCHASES OR SALES OF COLLECTIBLES
          OUTSIDE OF THIS APP. WE EXPRESSLY DENY ANY OBLIGATION TO INDEMNIFY YOU
          OR HOLD YOU HARMLESS FOR ANY LOSSES YOU MAY INCUR BY TRANSACTING, OR
          FACILITATING TRANSACTIONS INVOLVING COLLECTIBLES.
        </p>
        <br />
        <p>
          BY USING THE APP OR ANY PART OF IT OR INDICATING YOUR ACCEPTANCE IN AN
          ADJOINING BOX, YOU ARE CONFIRMING THAT YOU UNDERSTAND AND AGREE TO BE
          BOUND BY ALL OF THESE TERMS.
        </p>
        <p>
          Any changes to these Terms will be in effect as of the “Last Updated
          Date” referred to at the bottom of this page. You should review these
          Terms before using the App or purchasing any product or using any
          services that are available through this App.
        </p>
        <p>
          Your continued use of this App after the “Last Updated Date” will
        ...
        <p>
          ...
          these Terms, and you accept and are bound by these Terms.
        </p>
        <br />
        <p>
          You may not use this App if you: (i) do not agree to these Terms; (ii)
        ...
        <ul>
          ...
          <li class="mb-2">
            ...
            with us, you agree to notify us immediately at insert email address.
          </li>
          <li>
            1.4 Account Transactions. You can use your electronic wallet to
            purchase, store, and engage in transactions using your one or more
            cryptocurrencies that we may elect to accept from time to time.
            Transactions that take place on the App are managed and confirmed
            via the NEAR Network. You understand that your NEAR public address
        ...
        <ul>
          <li class="mb-2">
            ...
            transactions, nor do we have the ability to reverse any payments or
            ...
            transactions that you engage in via the App, or any other payment or
            transactions that you conduct via the NEAR Network. We do not
          ...
          <li class="mb-2">
            ...
            that you instigate via the App. Except as otherwise expressly set
            forth in these Terms, you will be solely responsible to pay any Gas
            Fee for any transaction that you instigate via the App.
          </li>
          <li>
            2.3 Responsibility for Taxes. You will be solely responsible to pay
            any and all sales, use, value-added and other taxes, duties, and
            assessments (except taxes on our net income) now or hereafter
            claimed or imposed by any governmental authority (collectively, the
            “Taxes”) associated with your use of the App. Except for income
            ...
            local or any other taxing jurisdiction; and (b) will not be entitled
            to deduct the amount of any such taxes, duties or assessments from
            payments (including Gas Fees) made to us pursuant to these Terms. To
            allow us to determine our tax obligations, unless you otherwise
            notify us in writing, you confirm that you are not a resident in
            Canada nor are you registered for Goods and services tax /
            Harmonized sales tax (GST / HST) or Provincial sales taxes (PST) in
        ...
        <p>
          For the purposes of this Section, the following capitalized terms will
          have the following meanings:
        </p>
        <p>
          All your information are stored in NEAR blockchain and can't be
          removed on application side.
        </p>
        <br />
        <ul>
          <li class="mb-2">
            ...
            property rights therein (including, without limitation, all media
            files, designs, systems, methods, information, computer code,
            software, services, “look and feel”, organization, compilation of
            the content, code, data, and all other elements of the App
            (collectively, the “App Materials”)). You acknowledge that the App
            ...
            All App Materials are the copyrighted property of us or our
          ...
          <li class="mb-2">
            ...
            data, or other App Materials that you may access on or through the
          ...
          <li class="mb-2">
            ...
            rights or licenses in or to the App Materials (including, without
            limitation, our copyright in and to the associated messages) other
            than those expressly contained in these Terms; (b) that you do not
            ...
            the App Materials (including, without limitation) without our prior
          ...
          <li>
            3.4 User Feedback. You may choose to submit comments, bug reports,
            ideas or other feedback about the App, including without limitation
            about how to improve the App (collectively, “Feedback”). By
        ...
        <br />
        <p>
          User Warranties. Without limiting the foregoing, you warrant and agree
          that your use of the App will not (and will not allow any third party
          to):(a) in any manner:
        </p>
        <ul>
          <li>
            - involve the sending, uploading, distributing or disseminating any
            unlawful, defamatory, harassing, abusive, fraudulent, obscene, or
            otherwise objectionable content;
          </li>
          <li>
            - involve the distribution of any viruses, worms, defects, Trojan
            horses, corrupted files, hoaxes, or any other items of a destructive
            or deceptive nature;
          </li>
          <li>
            - involve the uploading, posting, transmitting or otherwise making
            available through the App any content that infringes the
            intellectual proprietary rights of any party;
          </li>
          <li>
            - involve using the App to violate the legal rights (such as rights
            of privacy and publicity) of others;
          </li>
          <li>
            - involve engaging in, promoting, or encouraging illegal activity
            (including, without limitation, money laundering);
          </li>
          <li>- involve interfering with other users’ enjoyment of the App;</li>
          <li>
            - involve exploiting the App for any unauthorized commercial
            purpose;
          </li>
          <li>
            - involve modifying, adapting, translating, or reverse engineering
            any portion of the App;
          </li>
          <li>
            - involve removing any copyright, trademark or other proprietary
            rights notices contained in or on the App or any part of it;
          </li>
          <li>- involve reformatting or framing any portion of the App;</li>
          <li>
            - involve displaying any content on the App that contains any
          ...
          <li>
            - involve using any spider, site search/retrieval application, or
            other device to retrieve or index any portion of the App or the
            content posted on the App, or to collect information about its users
            for any unauthorized purpose;
          </li>
          <li>
            - involve accessing or using the App for the purpose of creating a
            product or service that is competitive with any of our products or
            services;
          </li>
          <li>
            - involve abusing, harassing, or threatening another user of the App
            or any of our authorized representatives, customer service
            personnel, chat board moderators, or volunteers (including, without
            limitation, filing support tickets with false information, sending
            excessive emails or support tickets, obstructing our employees from
            doing their jobs, refusing to follow the instructions of our
            employees, or publicly disparaging us by implying favoritism by a
            our employees or otherwise);
          </li>
          <li>
            - involve using any abusive, defamatory, ethnically or racially
            ...
            another user of the App or any of our authorized representatives,
            customer service personnel, chat board moderators, or volunteers
          </li>
        </ul>
        <br />
        <p>In any manner:</p>
        <ul>
          <li>
            - involve creating user accounts by automated means or under false
            or fraudulent pretenses;
          </li>
          <li>
            - involve the impersonation of another person (via the use of an
            email address or otherwise);
          </li>
          <li>
            - involve using, employing, operating, or creating a computer
            program to simulate the human behavior of a user (“Bots”);
          </li>
          <li>
            - involve using, employing, or operating Bots or other similar forms
            of automation to engage in any activity or transaction on the App;
          </li>
          <li>
            - involve the purchasing, selling or facilitating the purchase and
            sale of any user’s account(s) to other users or third parties for
            cash or cryptocurrency consideration outside of the App;
          </li>
          <li>
            - otherwise involve or result in the wrongful seizure or other
            digital assets (each, a “Category B Prohibited Activity” and,
            together with Category A Prohibited Activity, the “Prohibited
            Activities”). Effect of Your Breaches. If you engage in any of the
            Prohibited Activities, we may, at our sole and absolute discretion,
            without notice or liability to you, and without limiting any of our
        ...
        <p>
          ...
          ATOMICLAB AND THEIR RESPECTIVE PARENTS, SUBSIDIARIES, AFFILIATES, AND
          LICENSORS MAKE NO EXPRESS WARRANTIES AND HEREBY DISCLAIM ALL IMPLIED
          WARRANTIES REGARDING THE APP AND ANY PART OF IT INCLUDING THE IMPLIED
          WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE,
          NON-INFRINGEMENT, CORRECTNESS, ACCURACY, OR RELIABILITY. WITHOUT
          LIMITING THE GENERALITY OF THE FOREGOING, ATOMICLAB AND THEIR PARENTS,
          ...
          PROVIDED THROUGH THE APP WILL BE ACCURATE; (IV) THE APP OR ANY
        ...
        <p>
          ...
          DEALING ONLINE OVER THE INTERNET AND AGREE THAT ATOMICLAB HAVE NO
          LIABILITY OR RESPONSIBILITY FOR ANY BREACH OF SECURITY UNLESS IT IS
          DUE TO THEIR GROSS NEGLIGENCE.
        </p>
        <br />
        <p>
          ATOMICLAB WILL NOT BE RESPONSIBLE OR LIABLE TO YOU FOR ANY LOSSES YOU
          INCUR AS THE RESULT OF YOUR USE OF THE NEAR NETWORK, OR YOUR
          ELECTRONIC WALLET, INCLUDING BUT NOT LIMITED TO ANY LOSSES, DAMAGES OR
          CLAIMS ARISING FROM: (I) USER ERROR, SUCH AS FORGOTTEN PASSWORDS OR
          INCORRECTLY CONSTRUED SMART CONTRACTS OR OTHER TRANSACTIONS; (II)
          SERVER FAILURE OR DATA LOSS; (III) CORRUPTED WALLET FILES; (IV)
          ...
          OF ATTACK AGAINST THE APP, THE NEAR NETWORK, OR ANY ELECTRONIC WALLET
          OR (V) INCOMPLETE, SLOWED OR DISRUPTED TRANSACTIONS.
        </p>
        <br />
        <p>
          ATOMICLAB ARE NOT RESPONSIBLE FOR LOSSES DUE TO BLOCKCHAINS OR ANY
          OTHER FEATURES OF THE NEAR NETWORK, OR ANY ELECTRONIC WALLET,
        ...
        <p>
          ...
          LOSS OF DATA, LOSS OF GOODWILL, WORK STOPPAGE, DIMINUTION OF VALUE OR
          ANY OTHER INTANGIBLE LOSS, COMPUTER AND/OR DEVICE OR TECHNOLOGY
          FAILURE OR MALFUNCTION, OR FOR ANY FORM OF DIRECT OR INDIRECT DAMAGES,
          AND/OR ANY SPECIAL, INCIDENTAL, CONSEQUENTIAL, EXEMPLARY OR PUNITIVE
          DAMAGES BASED ON ANY CAUSES OF ACTION WHATSOEVER RELATED TO THE APP.
        ...
        <br />
        <p>
          YOU AGREE THAT THE TOTAL, AGGREGATE LIABILITY TO YOU FOR ANY AND ALL
          CLAIMS ARISING OUT OF OR RELATING TO THESE TERMS OR YOUR ACCESS TO OR
          USE OF (OR YOUR INABILITY TO ACCESS OR USE) ANY PORTION OF THE APP,
          WHETHER IN CONTRACT, TORT, STRICT LIABILITY, OR ANY OTHER LEGAL
          THEORY, IS LIMITED TO THE GREATER OF THE AMOUNTS YOU HAVE ACTUALLY AND
          LAWFULLY PAID US UNDER THESE TERMS IN THE TWO (2) MONTH PERIOD
          PRECEDING THE DATE THE CLAIM AROSE.
        </p>
        <br />
        <p>
          YOU ACKNOWLEDGE AND AGREE THAT WE HAVE MADE THE APP AVAILABLE TO YOU
          AND ENTERED INTO THESE TERMS IN RELIANCE UPON THE REPRESENTATIONS AND
          WARRANTIES, DISCLAIMERS AND LIMITATIONS OF LIABILITY SET FORTH HEREIN,
          WHICH REFLECT A REASONABLE AND FAIR ALLOCATION OF RISK BETWEEN US AND
        ...
        <ul>
          ...
          <li class="mb-2">
            ...
            your electronic wallet. You accept and acknowledge that we will not
          ...
          <li class="mb-2">
            ...
            development of NEAR ecosystem or ChatMe service.
          </li>
          <li>
            7.6 Software Risks. Upgrades to the NEAR Network, a hard fork in the
            NEAR Network, or a change in how transactions are confirmed on the
            NEAR Network may have unintended, adverse effects on all blockchains
            using the NEAR Network’s standard, including the ChatMe service.
          </li>
          <li>
            7.7 App chats and messages. The information presented in chats and
            direct messages has been provided by third parties and is made
            available solely for general information purposes. ChatMe does not
            warrant the accuracy of this information. The information should not
        ...
        <p>
          ...
          against any claim, liability, loss, damage (actual and consequential)
          of any kind or nature, suit, judgment, litigation cost and attorneys'
          fees arising out of or in any way related to: (i) your breach of these
          Terms; (ii) your misuse of the App; (iii) your violation of applicable
          laws, rules or regulations in connection with your access to or use of
          the App or (iv) any other of your activities in connection with App.
        ...
        <p>
          ...
          advertising, products or other materials on or made available from or
          through any External Sites. Furthermore, you acknowledge and agree
          that we are not liable for any loss or damage which may be incurred as
          a result of the availability or unavailability of the External Sites,
          or as a result of any reliance placed by you upon the completeness,
        ...
        <p class="mb-2">
          ...
          these Terms, when and to the extent such failure or delay is caused by
          or results from the following force majeure events (“Force Majeure
          Event(s)”): (a) flood, fire, earthquake, epidemics, pandemics,
          including the 2019 novel coronavirus pandemic (COVID-19), tsunami,
          explosion; (b) war, invasion, hostilities (whether war is declared or
          not), terrorist threats or acts, riot or other civil unrest; (c)
          government order, law, or action; (d) embargoes or blockades in effect
          on or after the date of this agreement; (e) strikes, labor stoppages
          or slowdowns or other industrial disturbances; (f) shortage of
          adequate or suitable Internet connectivity, telecommunication
          breakdown or shortage of adequate power or electricity; and (g) other
          similar events beyond our control.
        </p>
        <p>
          10.2 Performance During Force Majeure Events. If we suffer a Force
          Majeure Event, we will use reasonable efforts to promptly notify you
          of the Force Majeure Event, stating the period of time the occurrence
          is expected to continue. We will use diligent efforts to end the
          failure or delay and ensure the effects of such Force Majeure Event
          are minimized. We will resume the performance of our obligations as
          soon as reasonably practicable after the removal of the cause. In the
          event that our failure or delay remains uncured for a period of
          forty-five (45) consecutive days following written notice given by us
        ...
        <p>
          ...
          App, and any part of it, may change from time to time without prior
        ...
        <p>
          ...
          the App. We do not knowingly collect information from or direct any of
          our content specifically to children under the age of 18. If we learn
          or have reason to suspect that you are a user who is under the age of
          18, we will unfortunately have to close your account. Other countries
          may have different minimum age limits, and if you are below the
        ...
        <p>
          ...
          hereby incorporated by this reference into these Terms. You agree to
          the collection, use, storage, and disclosure of your data in
          accordance with our Privacy Policy.
        </p>
        <br />
        <p>Last Updated Date: 28 December 2022.</p>
      </div>
    </div>
    <Footer />
  </>
